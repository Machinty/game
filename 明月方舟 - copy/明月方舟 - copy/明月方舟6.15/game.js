...
class Game {
  ...
  constructor() {
    ...
    this.towerTypes = [
      ...
      { type: 'thrower', cost: 15, damage: 809, range: 120, color: '#8B0000', health: 100, game: this }, // 投掷塔颜色改为暗红色
         // 新增邵塔配置（橙色，成本90，伤害30，范围120，生命值150）
     { type: 'shao', cost: 22, damage: 973, range: 120, color: '#FFA500', health: 1837, game: this }
    ];
    this.enemyTypes = [
